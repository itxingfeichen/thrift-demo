...
public class Example implements org.apache.thrift.TBase<Example, Example._Fields>, java.io.Serializable, Cloneable, Comparable<Example> {
  ...
  static {
    schemes.put(StandardScheme.class, new ExampleStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ExampleTupleSchemeFactory());
  }
  ...
  public Example setGender(boolean gender) {
    this.gender = gender;
    setGenderIsSet(true);
    return this;
  }
  ...
  private static class ExampleStandardSchemeFactory implements SchemeFactory {
    public ExampleStandardScheme getScheme() {
      return new ExampleStandardScheme();
    }
  }

  private static class ExampleStandardScheme extends StandardScheme<Example> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Example struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Example struct) throws TException {
      struct.validate();
  ...
  private static class ExampleTupleSchemeFactory implements SchemeFactory {
    public ExampleTupleScheme getScheme() {
      return new ExampleTupleScheme();
    }
  }

  private static class ExampleTupleScheme extends TupleScheme<Example> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Example struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Example struct) throws TException {
